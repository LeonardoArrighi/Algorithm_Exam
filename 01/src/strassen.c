                      ...
                      const size_t B_f_col, const size_t A_row, const size_t A_col, const size_t B_col)
{
    ...
    // P2 = S2 x B22
    strassen_aux_gen(P[0], (const float* const* const)S[0], B, 0, 0, 0, 0, B_f_row + A_col_e, B_f_col + B_col_e, A_row_e, A_col_e, B_col_e);
    ...
    // P3 = S3 x B11
    strassen_aux_gen(P[0], (const float* const* const)S[0], B, 0, 0, 0, 0, B_f_row, B_f_col, A_row_e, A_col_e, B_col_e);
    ...
    // P4 = A22 x S4
    strassen_aux_gen(P[0], A, (const float* const* const)S[0], 0, 0, A_f_row + A_row_e, A_f_col + A_col_e, 0, 0, A_row_e, A_col_e, B_col_e);
    ...
    // P5 = S5 x S6
    strassen_aux_gen(P[0], (const float* const* const)S[0], (const float* const* const)S[1], 0, 0, 0, 0, 0, 0, A_row_e, A_col_e,
                     B_col_e);
