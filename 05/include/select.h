...
/**********************************************************************
 * An implementation for the Median of Medians algorithm.
 *
 * This funcion implements the median of medians algorithm which is a
 * select algorithm: it is used to select the pivot for the selection
 * algorithm. Median of medians finds an approximate median in linear 
 * time only dividing the algorithm in chuncks with size equal to 5.
 *
 * @param A is the array of which the i-th value should be found. 
 *          The original ordering of the array may be destroyed.
 * @param n is the number of element of A.
